...
def add_arguments(parser):
    ...
    parser.add_argument('-m', '--model', help='which model?',
                        default="GRUSeq2SeqWithFeatures", type=str)
    ...
    parser.add_argument('-l', '--learning_rate', default=0.0002, type=float)
    parser.add_argument('-s', '--save_dir',
                        help='path to save and log files', default=os.path.join(DEFAULT_DATA_DIR, 'default_model'), type=str)
    parser.add_argument('-d', '--device',
                        help="number of cuda visible devise", default="0，1", type=str)
    parser.add_argument('-gmf', '--gpu_mem_frac', default=0.9, type=float)
    ...
    parser.add_argument('--train_file', default="data/chem_train.csv", type=str)
    parser.add_argument('--val_file', default="data/chem_test.csv", type=str)
    parser.add_argument('--infer_file', default="data/ames.csv", type=str)
